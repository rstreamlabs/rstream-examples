...
- The MediaMTX guide will add a distribution adapter to the producer. One
  adaptive upstream will feed multi-viewer fan-out while direct WebRTC remains
  available for one-to-one delivery and transport diagnosis.
