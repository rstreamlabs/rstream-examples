...
function producerSetupPrompt({
  ...
  return [
    ...
    "README: https://github.com/rstreamlabs/rstream-examples/tree/main/webrtc-video/producer#readme",
    "Sample directory: webrtc-video/producer",
    ...
    "3. Run these commands from rstream-examples/webrtc-video/producer:",
    "make build-provisioning",
    `export API_URL=${shellQuote(apiUrl)}`,
    secret
      ? `export DEVICE_SECRET=${shellQuote(secret)}`
