...
Generated at 2026-08-17T02:19:25Z from repository revision `ca8a308907aaa5661954af81d10f04bd8e5f52bb`.
...
| producer-build-completed | 138.6 s |
| browser-build-started | 0.1 s |
| browser-build-completed | 24.3 s |
| connection-started | 0.0 s |
| producer-container-started | 0.4 s |
| producer-ready | 1.1 s |
| browser-container-started | 0.0 s |
| media-connected | 11.1 s |

Measured service establishment: 12.5 s.
...
Candidate-pair switches: 1. Fresh remote candidates: 1. ICE restart offers: 1. Longest playback interruption: 1.0 s.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 100.0% | 8386 | n/a | 8000 | 8000 | 30.0 | 23.1 | 2.96 | 0.0% | 0 | 0 | 2981 | 7 |
| baseline | 25 | 100.0% | 8663 | n/a | 8000 | 8000 | 30.0 | 23.1 | 3.07 | 0.0% | 0 | 0 | 4065 | 5 |
| mobility | 30 | 96.7% | 6555 | n/a | 7700 | 6250 | 21.4 | 24.7 | 2.76 | 6.6% | 0 | 0 | 2916 | 6 |
| conditioning | 30 | 100.0% | 8547 | 26.7% | 8000 | 8000 | 30.0 | 23.5 | 2.97 | 0.0% | 0 | 0 | 4934 | 9 |
| constrained | 45 | 100.0% | 2600 | 65.0% | 2400 | 2000 | 30.0 | 30.5 | 2.51 | 0.0% | 0 | 0 | 3302 | 18 |
| impaired | 34 | 100.0% | 2471 | 61.8% | 2300 | 2000 | 29.8 | 31.5 | 2.42 | 0.6% | 170 | 151 | 1900 | 215 |
| recovery | 45 | 100.0% | 8267 | 25.8% | 8000 | 8000 | 30.2 | 24.8 | 2.73 | 0.0% | 1 | 1 | 5670 | 163 |

Congestion response: 1.0 s. Recovery response: 16.1 s.

Selected ICE candidate-pair switches: 1. Both peers remain on the required TURN relay path.

Superseded out-of-order estimator callbacks: 4. The producer always applies the estimator's current target rather than the potentially stale callback payload.
...
| Rate recovery | 16.1 s to threshold; 100.0% target residency in the best 10 s window; 23.1 s longest uninterrupted interval; received throughput 94.5% of the stable pre-transition rate | target reaches 80% within 35 s, sustains it for 10 s, and median throughput reaches at least 60% of the stable pre-transition rate |
| Playback under impairment | 29.8 fps; 0.6% frozen | at least 20 fps; at most 10% frozen |
| Latency under impairment | 215 ms max RTT; 201.6 ms effective playout buffer | at most 600 ms RTT; at most 300 ms phase-average buffer |
| Visual quality under impairment | QP 31.5; 1920x1080 | QP at most 42; 1920x1080 |
| Loss fidelity | qdisc 2.01%; TWCC 2.20% | 2% injected; TWCC within 8 percentage points |
| Packet repair | NACK 170; sender RTX 184; receiver RTX 151; FlexFEC 1900 | NACK, sender RTX, and FlexFEC greater than zero |
| Sender queue | 53.8 ms residence; 51.1 ms admitted backlog; 0 overflow drops | at most 375 ms; at most 225 ms; zero overflow |
...
| mobility | 7666 | 7721 | 0 | 98.34% | 0 / 0 | 0.00% | 29.96% | 6 | 0 | 353 | 0 | 0 |
| conditioning | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 0 | 0 | 464 | 0 | 0 |
| constrained | 2369 | 2373 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 17 | 0 | 718 | 0 | 0 |
| impaired | 2278 | 2302 | 0 | 12.00% | 0 / 0 | 1.67% | 2.20% | 0 | 0 | 515 | 208 | 0 |
| recovery | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 7 | 0 | 704 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 44.7 | 44.7 | 43.5 | 43.1 | 53.7 | 30 | 68049 | 0 | 0 | 3 | 0 | 0 | 0 | 0 | 0 | 0 |
| baseline | 44.7 | 44.7 | 43.5 | 43.1 | 53.7 | 33 | 68245 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| mobility | 47.9 | 47.9 | 43.5 | 43.1 | 53.7 | 31 | 68104 | 0 | 0 | 10 | 2 | 1 | 2 | 0 | 0 | 0 |
| conditioning | 47.9 | 47.9 | 43.5 | 43.1 | 53.7 | 33 | 67697 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| constrained | 53.8 | 52.7 | 53.8 | 51.1 | 63.7 | 31 | 64580 | 0 | 0 | 11 | 0 | 0 | 0 | 0 | 0 | 0 |
| impaired | 53.8 | 52.7 | 53.8 | 51.1 | 63.7 | 8 | 21869 | 0 | 0 | 9 | 0 | 0 | 0 | 0 | 0 | 0 |
| recovery | 53.8 | 52.7 | 53.8 | 51.1 | 63.7 | 32 | 68113 | 0 | 0 | 4 | 1 | 0 | 0 | 0 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 43.5 | 2922 | 0 | 3 | 0.0 | 0 | 0 | 0 | 0 |
| baseline | 43.5 | 4045 | 0 | 0 | 0.0 | 0 | 0 | 0 | 0 |
| mobility | 43.5 | 3948 | 0 | 10 | 0.0 | 0 | 0 | 0 | 0 |
| conditioning | 43.5 | 4928 | 0 | 0 | 0.0 | 0 | 0 | 0 | 0 |
| constrained | 53.8 | 3451 | 0 | 11 | 0.0 | 0 | 0 | 0 | 0 |
| impaired | 53.8 | 1939 | 0 | 7 | 37.1 | 184 | 0 | 2 | 0 |
| recovery | 53.8 | 5558 | 0 | 4 | 37.1 | 1 | 0 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 78 | 23.4% | 0.0% | 0.0% | 254 ms | 254 ms |
| baseline | 99 | 24.0% | 0.0% | 0.0% | 255 ms | 255 ms |
| mobility | 120 | 21.9% | 0.0% | 0.0% | 254 ms | 254 ms |
| conditioning | 118 | 24.7% | 0.0% | 0.0% | 253 ms | 254 ms |
| constrained | 177 | 22.1% | 0.0% | 0.0% | 255 ms | 255 ms |
| impaired | 138 | 21.4% | 0.0% | 0.0% | 254 ms | 255 ms |
| recovery | 178 | 23.5% | 0.0% | 0.0% | 255 ms | 256 ms |
...
| Phase | Samples | Median active CPU | p95 steal | Maximum steal | p99 sampler gap | Maximum sampler gap |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 22.9% | 0.0% | 0.0% | 254 ms | 254 ms |
| baseline | 98 | 23.8% | 0.0% | 0.0% | 254 ms | 254 ms |
| mobility | 120 | 22.0% | 0.0% | 0.0% | 254 ms | 254 ms |
| conditioning | 119 | 24.7% | 0.0% | 0.0% | 254 ms | 254 ms |
| constrained | 177 | 21.9% | 0.0% | 0.0% | 254 ms | 254 ms |
| impaired | 138 | 20.8% | 0.0% | 0.0% | 254 ms | 255 ms |
| recovery | 178 | 23.4% | 0.0% | 0.0% | 254 ms | 254 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| warmup | 601 | 37.4 | 39.3 | 0.00% | 0.00% |
| baseline | 752 | 36.8 | 40.7 | 0.00% | 0.00% |
| mobility | 915 | 36.5 | 39.4 | 0.00% | 0.00% |
| conditioning | 901 | 36.1 | 38.8 | 0.00% | 0.00% |
| constrained | 1350 | 36.8 | 40.7 | 0.00% | 0.00% |
| impaired | 1050 | 36.6 | 39.3 | 0.00% | 0.00% |
| recovery | 1249 | 37.1 | 42.9 | 0.00% | 0.00% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| capacity transitions | 0.00% | 11501 | 0 | 0.00% | n/a |
| constrained steady state | 0.00% | 9185 | 0 | 0.00% | 0/256 (0.0%) |
| impaired (incremental) | 2.00% | 12352 | 254 | 2.01% | 66/256 (25.8%) |
| recovery drain | 0.00% | 1029 | 0 | 0.00% | 0/256 (0.0%) |
...
| --- | ---: | ---: |
| warmup | 187.7 | 185.8 |
| baseline | 189.3 | 185.5 |
| mobility | 186.9 | 186.0 |
| conditioning | 187.6 | 185.6 |
| constrained | 192.8 | 185.9 |
| impaired | 201.6 | 186.0 |
| recovery | 208.5 | 185.9 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 18437 | 467 | 0 | 0 | 0 | 0 |
| baseline | 25 | 25361 | 580 | 0 | 0 | 0 | 0 |
| mobility | 30 | 17610 | 643 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 30605 | 686 | 0 | 0 | 0 | 0 |
| constrained | 45 | 21173 | 1026 | 0 | 0 | 0 | 0 |
| impaired | 35 | 12405 | 984 | 0 | 0 | 0 | 0 |
| recovery | 45 | 34282 | 1029 | 0 | 0 | 0 | 0 |
...
| Phase | Samples | UDP received | UDP sent | Input errors | No-socket drops | Receive-buffer drops | Send-buffer drops |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 482 | 18457 | 0 | 0 | 0 | 0 |
| baseline | 25 | 601 | 25386 | 0 | 0 | 0 | 0 |
| mobility | 30 | 588 | 24445 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 726 | 30640 | 0 | 0 | 0 | 0 |
| constrained | 45 | 1082 | 21216 | 0 | 0 | 0 | 0 |
| impaired | 35 | 1014 | 12749 | 0 | 0 | 0 | 0 |
| recovery | 45 | 1084 | 34323 | 0 | 0 | 0 | 0 |
...
- PASS — mobility-source-address: the producer moves to a distinct source address during the controlled interface switch
- PASS — trickle-ice-mobility: the producer trickles at least one fresh candidate and WebRTC selects a new candidate pair after the interface switch
- PASS — quic-signaling-mobility: the original WebRTC peer and signaling WebSocket survive the producer network change over the rstream QUIC upstream
- PASS — mobility-recovery: video playback remains continuous or recovers within 15 seconds of the producer interface switch
...
- PASS — loss-guard-response: two consecutive TWCC sampling intervals above 10% loss reduce an encoder target that remains above its configured floor without waiting for a delay-estimator callback
