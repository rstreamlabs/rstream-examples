...
| browser-build-completed | 23.7 s |
...
Measured service establishment: 7.4 s.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 100.0% | 6899 | n/a | 8000 | 8000 | 30.0 | 23.3 | 2.71 | 0.0% | 0 | 0 | 0 | 1 |
| baseline | 25 | 100.0% | 7021 | n/a | 8000 | 8000 | 30.0 | 23.1 | 2.76 | 0.0% | 0 | 0 | 0 | 2 |
| conditioning | 30 | 100.0% | 7021 | 21.9% | 8000 | 8000 | 30.0 | 23.3 | 2.77 | 0.0% | 0 | 0 | 0 | 4 |
| constrained | 45 | 100.0% | 2624 | 65.6% | 2400 | 2000 | 27.9 | 28.2 | 2.53 | 6.6% | 357 | 324 | 0 | 592 |
| impaired | 35 | 100.0% | 1898 | 47.5% | 2000 | 2000 | 29.5 | 31.6 | 2.22 | 4.1% | 390 | 203 | 0 | 217 |
| recovery | 45 | 100.0% | 7006 | 21.9% | 8000 | 8000 | 30.0 | 24.6 | 2.56 | 0.0% | 0 | 0 | 0 | 8 |

Congestion response: 11.1 s. Recovery response: 4.0 s.
...
| Rate response | 75.0% reduction in 11.1 s | at least 20% within 30 s |
| Rate recovery | 4.0 s to threshold; 100.0% target residency in the best 10 s window; 35.2 s longest uninterrupted interval; received throughput 97.5% of the stable pre-transition rate | target reaches 80% within 35 s, sustains it for 10 s, and median throughput reaches at least 60% of baseline |
| Playback under impairment | 29.5 fps; 4.1% frozen | at least 20 fps; at most 10% frozen |
| Latency under impairment | 217 ms max RTT; 192.7 ms effective playout buffer | at most 600 ms RTT; at most 300 ms phase-average buffer |
| Visual quality under impairment | QP 31.6; 1920x1080 | QP at most 42; 1920x1080 |
| Loss fidelity | qdisc 1.96%; TWCC 3.79% | 2% injected; TWCC within 8 percentage points |
| Packet repair | NACK 390; sender RTX 409; receiver RTX 203 | NACK, sender RTX, and receiver RTX greater than zero |
| Sender queue | 224.9 ms residence; 58.4 ms admitted backlog; 0 overflow drops | at most 375 ms; at most 225 ms; zero overflow |
...
| constrained | 2898 | 5133 | 2000 | 32.35% | 5 / 1 | 0.00% | 2.70% | 10 | 0 | 694 | 59 | 0 |
| impaired | 2083 | 2211 | 2000 | 12.50% | 0 / 1 | 3.49% | 3.79% | 2 | 0 | 554 | 347 | 0 |
| recovery | 8000 | 8000 | 6773 | 0.00% | 0 / 26 | 0.00% | 0.00% | 2 | 0 | 704 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 37.1 | 37.1 | 0.0 | 45.4 | 46.2 | 12 | 68123 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| baseline | 37.4 | 37.4 | 0.0 | 45.5 | 46.3 | 11 | 68225 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| conditioning | 37.4 | 37.4 | 0.0 | 45.5 | 46.3 | 12 | 68142 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| constrained | 224.9 | 49.6 | 224.9 | 58.4 | 963.5 | 152 | 64345 | 0 | 1632 | 710 | 0 | 0 | 0 | 0 | 0 | 0 |
| impaired | 224.9 | 50.0 | 224.9 | 58.4 | 963.5 | 5 | 44426 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| recovery | 224.9 | 50.0 | 224.9 | 58.4 | 963.5 | 12 | 67935 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 0 | 0 |
...
| constrained | 0.0 | 0 | 0 | 0 | 224.9 | 543 | 1632 | 710 | 3503 |
| impaired | 0.0 | 0 | 0 | 0 | 224.9 | 409 | 0 | 0 | 0 |
| recovery | 0.0 | 0 | 0 | 0 | 224.9 | 0 | 0 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 21.6% | 0.0% | 0.0% | 254 ms | 254 ms |
| baseline | 100 | 21.4% | 0.0% | 0.0% | 254 ms | 254 ms |
| conditioning | 118 | 22.9% | 0.0% | 0.0% | 254 ms | 254 ms |
| constrained | 178 | 21.6% | 0.0% | 0.0% | 254 ms | 254 ms |
| impaired | 138 | 19.8% | 0.0% | 0.0% | 254 ms | 254 ms |
| recovery | 177 | 22.1% | 0.0% | 0.0% | 254 ms | 254 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 21.6% | 0.0% | 0.0% | 254 ms | 254 ms |
| baseline | 99 | 21.4% | 0.0% | 0.0% | 254 ms | 254 ms |
| conditioning | 119 | 22.9% | 0.0% | 0.0% | 254 ms | 254 ms |
| constrained | 177 | 21.4% | 0.0% | 0.0% | 254 ms | 254 ms |
| impaired | 138 | 19.6% | 0.0% | 0.0% | 254 ms | 255 ms |
| recovery | 178 | 22.3% | 0.0% | 0.0% | 254 ms | 254 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| warmup | 601 | 36.2 | 38.3 | 0.00% | 0.00% |
| baseline | 761 | 36.1 | 38.9 | 0.00% | 0.00% |
| conditioning | 902 | 36.8 | 38.1 | 0.00% | 0.00% |
| constrained | 1352 | 36.2 | 39.4 | 0.00% | 0.00% |
| impaired | 1049 | 36.2 | 37.2 | 0.00% | 0.00% |
| recovery | 1347 | 36.2 | 38.8 | 0.00% | 0.00% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| capacity transitions | 0.00% | 14198 | 588 | 3.98% | n/a |
| constrained steady state | 0.00% | 8350 | 0 | 0.00% | 21/256 (8.2%) |
| impaired (incremental) | 2.00% | 10631 | 213 | 1.96% | 46/256 (18.0%) |
| recovery drain | 0.00% | 816 | 0 | 0.00% | 0/256 (0.0%) |
...
| --- | ---: | ---: |
| warmup | 188.5 | 186.0 |
| baseline | 190.2 | 186.0 |
| conditioning | 190.1 | 186.0 |
| constrained | 189.8 | 186.3 |
| impaired | 192.7 | 186.6 |
| recovery | 203.3 | 186.2 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 16220 | 358 | 0 | 0 | 0 | 0 |
| baseline | 25 | 21077 | 459 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 25434 | 537 | 0 | 0 | 0 | 0 |
| constrained | 45 | 22768 | 1168 | 0 | 0 | 0 | 0 |
| impaired | 35 | 10722 | 986 | 0 | 0 | 0 | 0 |
| recovery | 45 | 32421 | 820 | 0 | 0 | 0 | 0 |
...
| Phase | Samples | UDP received | UDP sent | Input errors | No-socket drops | Receive-buffer drops | Send-buffer drops |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 358 | 16220 | 0 | 0 | 0 | 0 |
| baseline | 25 | 447 | 21062 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 535 | 25432 | 0 | 0 | 0 | 0 |
| constrained | 45 | 1158 | 22762 | 0 | 0 | 0 | 588 |
| impaired | 35 | 985 | 10968 | 0 | 0 | 0 | 0 |
| recovery | 45 | 803 | 32361 | 0 | 0 | 0 | 0 |
