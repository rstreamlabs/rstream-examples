...
Generated at 2026-08-17T01:38:00Z from repository revision `ca8a308907aaa5661954af81d10f04bd8e5f52bb`.
...
| producer-build-completed | 133.8 s |
| browser-build-started | 0.1 s |
| browser-build-completed | 23.9 s |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 100.0% | 6818 | n/a | 8000 | 7800 | 30.0 | 23.4 | 2.36 | 0.0% | 0 | 0 | 0 | 112 |
| baseline | 25 | 100.0% | 7068 | n/a | 8000 | 8000 | 30.0 | 23.1 | 2.40 | 0.0% | 0 | 0 | 0 | 113 |
| conditioning | 30 | 100.0% | 6944 | 21.7% | 8000 | 8000 | 30.0 | 23.3 | 2.44 | 0.0% | 0 | 0 | 0 | 116 |
| constrained | 44 | 100.0% | 2718 | 67.9% | 3200 | 2900 | 30.0 | 29.1 | 2.35 | 0.0% | 0 | 0 | 0 | 142 |
| impaired | 35 | 100.0% | 1899 | 47.5% | 2000 | 2000 | 28.6 | 31.3 | 2.13 | 12.8% | 564 | 215 | 0 | 321 |
| recovery | 45 | 100.0% | 6461 | 20.2% | 8000 | 7800 | 30.1 | 24.6 | 2.25 | 0.0% | 0 | 1 | 0 | 280 |

Congestion response: 8.0 s. Recovery response: 13.1 s.
...
| Rate response | 63.7% reduction in 8.0 s | at least 20% within 30 s |
| Rate recovery | 13.1 s to threshold; 100.0% target residency in the best 10 s window; 26.2 s longest uninterrupted interval; received throughput 93.1% of the stable pre-transition rate | target reaches 80% within 35 s, sustains it for 10 s, and median throughput reaches at least 60% of baseline |
| Playback under impairment | 28.6 fps; 12.8% frozen | at least 20 fps; at most 10% frozen |
| Latency under impairment | 321 ms max RTT; 233.1 ms effective playout buffer | at most 600 ms RTT; at most 300 ms phase-average buffer |
| Visual quality under impairment | QP 31.3; 1920x1080 | QP at most 42; 1920x1080 |
| Loss fidelity | qdisc 2.14%; TWCC 5.90% | 2% injected; TWCC within 8 percentage points |
| Packet repair | NACK 564; sender RTX 628; receiver RTX 215 | NACK, sender RTX, and receiver RTX greater than zero |
| Sender queue | 51.9 ms residence; 60.5 ms admitted backlog; 0 overflow drops | at most 375 ms; at most 225 ms; zero overflow |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 0 | 0 | 304 | 0 | 0 |
| baseline | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 2 | 0 | 384 | 0 | 0 |
| conditioning | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 0 | 0 | 464 | 0 | 0 |
| constrained | 3221 | 3239 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 14 | 0 | 702 | 0 | 0 |
| impaired | 1514 | 2187 | 2000 | 21.74% | 0 / 0 | 5.89% | 5.90% | 1 | 0 | 530 | 413 | 0 |
| recovery | 8000 | 8000 | 0 | 3.33% | 0 / 1 | 0.00% | 0.05% | 6 | 0 | 704 | 17 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 41.2 | 41.2 | 0.0 | 49.8 | 50.7 | 16 | 68046 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| baseline | 41.2 | 41.2 | 0.0 | 49.8 | 50.7 | 17 | 68353 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| conditioning | 41.2 | 41.2 | 0.0 | 49.8 | 50.7 | 29 | 68204 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| constrained | 51.9 | 51.9 | 0.0 | 60.5 | 61.7 | 19 | 67853 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| impaired | 51.9 | 51.9 | 32.9 | 60.5 | 61.7 | 5 | 25379 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| recovery | 51.9 | 51.9 | 32.9 | 60.5 | 61.7 | 11 | 67771 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 0 | 0 |
...
| impaired | 0.0 | 0 | 0 | 0 | 32.9 | 628 | 0 | 0 | 0 |
| recovery | 0.0 | 0 | 0 | 0 | 32.9 | 8 | 0 | 0 | 0 |
...
| baseline | 100 | 22.4% | 0.0% | 0.0% | 255 ms | 255 ms |
| conditioning | 118 | 23.7% | 0.0% | 0.0% | 254 ms | 254 ms |
| constrained | 177 | 21.6% | 0.0% | 0.0% | 254 ms | 256 ms |
| impaired | 138 | 19.6% | 0.0% | 0.0% | 254 ms | 255 ms |
| recovery | 178 | 21.9% | 0.0% | 0.0% | 255 ms | 256 ms |
...
| Phase | Samples | Median active CPU | p95 steal | Maximum steal | p99 sampler gap | Maximum sampler gap |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 22.4% | 0.0% | 0.0% | 254 ms | 254 ms |
| baseline | 100 | 22.3% | 0.0% | 0.0% | 253 ms | 253 ms |
| conditioning | 118 | 24.0% | 0.0% | 0.0% | 254 ms | 254 ms |
| constrained | 177 | 21.6% | 0.0% | 0.0% | 254 ms | 254 ms |
| impaired | 138 | 19.4% | 0.0% | 0.0% | 254 ms | 254 ms |
| recovery | 178 | 21.9% | 0.0% | 0.0% | 255 ms | 255 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| warmup | 601 | 35.9 | 37.4 | 0.00% | 0.00% |
| baseline | 761 | 37.0 | 38.1 | 0.00% | 0.00% |
| conditioning | 899 | 37.0 | 38.2 | 0.00% | 0.00% |
| constrained | 1352 | 36.5 | 39.5 | 0.00% | 0.00% |
| impaired | 1049 | 36.3 | 37.8 | 0.00% | 0.00% |
| recovery | 1197 | 36.6 | 43.3 | 0.00% | 0.00% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| capacity transitions | 0.00% | 12004 | 0 | 0.00% | n/a |
| constrained steady state | 0.00% | 9197 | 0 | 0.00% | 0/256 (0.0%) |
| impaired (incremental) | 2.00% | 10744 | 235 | 2.14% | 54/256 (21.1%) |
| recovery drain | 0.00% | 824 | 0 | 0.00% | 0/256 (0.0%) |
...
| --- | ---: | ---: |
| warmup | 189.6 | 187.0 |
| baseline | 189.7 | 187.0 |
| conditioning | 190.3 | 187.0 |
| constrained | 194.3 | 186.3 |
| impaired | 233.1 | 186.6 |
| recovery | 206.6 | 186.9 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 16520 | 376 | 0 | 0 | 0 | 0 |
| baseline | 25 | 20719 | 451 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 25336 | 549 | 0 | 0 | 0 | 0 |
| constrained | 45 | 21422 | 802 | 0 | 0 | 0 | 0 |
| impaired | 35 | 10799 | 1171 | 0 | 0 | 0 | 0 |
| recovery | 45 | 28686 | 820 | 0 | 0 | 0 | 0 |
...
| Phase | Samples | UDP received | UDP sent | Input errors | No-socket drops | Receive-buffer drops | Send-buffer drops |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 382 | 16506 | 0 | 0 | 0 | 0 |
| baseline | 25 | 480 | 20725 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 574 | 25385 | 0 | 0 | 0 | 0 |
| constrained | 45 | 868 | 21480 | 0 | 0 | 0 | 0 |
| impaired | 35 | 1200 | 11110 | 0 | 0 | 0 | 0 |
| recovery | 45 | 876 | 28740 | 0 | 0 | 0 | 0 |
