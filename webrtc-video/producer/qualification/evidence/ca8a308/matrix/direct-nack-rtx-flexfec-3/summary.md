...
Generated at 2026-08-17T01:18:05Z from repository revision `ca8a308907aaa5661954af81d10f04bd8e5f52bb`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 100.0% | 8858 | n/a | 8000 | 8000 | 30.0 | 23.3 | 2.95 | 0.0% | 0 | 0 | 3226 | 2 |
| baseline | 25 | 100.0% | 8650 | n/a | 8000 | 8000 | 30.0 | 23.1 | 2.89 | 0.0% | 0 | 0 | 4027 | 1 |
| conditioning | 30 | 100.0% | 8796 | 27.5% | 8000 | 8000 | 30.0 | 23.3 | 2.94 | 0.0% | 0 | 0 | 4932 | 5 |
| constrained | 45 | 100.0% | 2712 | 67.8% | 2500 | 2300 | 30.0 | 29.7 | 2.60 | 0.0% | 0 | 0 | 3288 | 15 |
| impaired | 35 | 100.0% | 2428 | 60.7% | 2200 | 2000 | 29.9 | 31.5 | 2.10 | 0.6% | 144 | 137 | 1962 | 195 |
| recovery | 45 | 100.0% | 8411 | 26.3% | 8000 | 8000 | 30.1 | 25.9 | 2.57 | 0.0% | 0 | 0 | 5579 | 38 |

Congestion response: 1.0 s. Recovery response: 18.1 s.
...
| Rate response | 71.3% reduction in 1.0 s | at least 20% within 30 s |
| Rate recovery | 18.1 s to threshold; 100.0% target residency in the best 10 s window; 21.1 s longest uninterrupted interval; received throughput 97.1% of the stable pre-transition rate | target reaches 80% within 35 s, sustains it for 10 s, and median throughput reaches at least 60% of baseline |
| Playback under impairment | 29.9 fps; 0.6% frozen | at least 20 fps; at most 10% frozen |
| Latency under impairment | 195 ms max RTT; 185.3 ms effective playout buffer | at most 600 ms RTT; at most 300 ms phase-average buffer |
| Visual quality under impairment | QP 31.5; 1920x1080 | QP at most 42; 1920x1080 |
| Loss fidelity | qdisc 1.76%; TWCC 1.76% | 2% injected; TWCC within 8 percentage points |
| Packet repair | NACK 144; sender RTX 151; receiver RTX 137; FlexFEC 1962 | NACK, sender RTX, and FlexFEC greater than zero |
| Sender queue | 51.3 ms residence; 49.7 ms admitted backlog; 0 overflow drops | at most 375 ms; at most 225 ms; zero overflow |
...
| constrained | 2517 | 2521 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 24 | 0 | 704 | 0 | 0 |
| impaired | 2245 | 2262 | 2212 | 8.70% | 1 / 3 | 1.12% | 1.76% | 0 | 0 | 555 | 171 | 0 |
| recovery | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 9 | 0 | 704 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 36.8 | 36.8 | 34.7 | 37.8 | 45.0 | 12 | 68034 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| baseline | 37.4 | 37.4 | 37.2 | 37.9 | 46.8 | 20 | 68151 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| conditioning | 37.4 | 37.4 | 37.2 | 37.9 | 46.8 | 12 | 67910 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| constrained | 51.3 | 51.3 | 49.1 | 49.7 | 59.0 | 7 | 66681 | 0 | 0 | 16 | 0 | 0 | 0 | 0 | 0 | 0 |
| impaired | 51.3 | 51.3 | 49.1 | 49.7 | 59.0 | 5 | 26632 | 0 | 0 | 11 | 0 | 0 | 0 | 0 | 0 | 0 |
| recovery | 51.3 | 51.3 | 50.9 | 49.7 | 60.1 | 10 | 67614 | 0 | 0 | 9 | 1 | 0 | 0 | 0 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 34.7 | 3209 | 0 | 0 | 0.0 | 0 | 0 | 0 | 0 |
| baseline | 37.2 | 4011 | 0 | 0 | 0.0 | 0 | 0 | 0 | 0 |
| conditioning | 37.2 | 4898 | 0 | 0 | 0.0 | 0 | 0 | 0 | 0 |
| constrained | 49.1 | 3322 | 0 | 16 | 0.0 | 0 | 0 | 0 | 0 |
| impaired | 49.1 | 2049 | 0 | 11 | 22.4 | 151 | 0 | 0 | 0 |
| recovery | 50.9 | 5535 | 0 | 9 | 22.4 | 0 | 0 | 0 | 0 |
...
| baseline | 100 | 25.0% | 0.0% | 0.0% | 254 ms | 254 ms |
| conditioning | 118 | 26.5% | 0.0% | 0.0% | 254 ms | 255 ms |
| constrained | 178 | 24.8% | 0.0% | 0.0% | 255 ms | 255 ms |
| impaired | 138 | 23.6% | 0.0% | 0.0% | 254 ms | 254 ms |
| recovery | 178 | 25.3% | 0.0% | 0.0% | 254 ms | 255 ms |
...
| baseline | 99 | 25.0% | 0.0% | 0.0% | 254 ms | 254 ms |
| conditioning | 119 | 26.3% | 0.0% | 0.0% | 253 ms | 254 ms |
| constrained | 177 | 24.2% | 0.0% | 0.0% | 254 ms | 255 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| warmup | 602 | 36.3 | 37.8 | 0.00% | 0.00% |
| baseline | 760 | 36.4 | 40.2 | 0.00% | 0.00% |
| conditioning | 900 | 36.4 | 38.2 | 0.00% | 0.00% |
| constrained | 1349 | 36.5 | 38.1 | 0.00% | 0.00% |
| impaired | 1050 | 36.4 | 40.4 | 0.00% | 0.00% |
| recovery | 1351 | 36.1 | 37.7 | 0.00% | 0.00% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| capacity transitions | 0.00% | 11073 | 0 | 0.00% | n/a |
| constrained steady state | 0.00% | 9314 | 0 | 0.00% | 0/256 (0.0%) |
| impaired (incremental) | 2.00% | 12297 | 220 | 1.76% | 62/256 (24.2%) |
| recovery drain | 0.00% | 994 | 0 | 0.00% | 0/256 (0.0%) |
...
| --- | ---: | ---: |
| warmup | 189.3 | 185.2 |
| baseline | 189.9 | 185.6 |
| conditioning | 189.9 | 185.5 |
| constrained | 194.1 | 185.8 |
| impaired | 185.3 | 186.4 |
| recovery | 206.2 | 186.1 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 20227 | 456 | 0 | 0 | 0 | 0 |
| baseline | 25 | 25143 | 576 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 30499 | 694 | 0 | 0 | 0 | 0 |
| constrained | 45 | 20604 | 1031 | 0 | 0 | 0 | 0 |
| impaired | 35 | 12312 | 958 | 0 | 0 | 0 | 0 |
| recovery | 45 | 33671 | 1033 | 0 | 0 | 0 | 0 |
...
| Phase | Samples | UDP received | UDP sent | Input errors | No-socket drops | Receive-buffer drops | Send-buffer drops |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 21 | 458 | 20225 | 0 | 0 | 0 | 0 |
| baseline | 25 | 568 | 25132 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 682 | 30475 | 0 | 0 | 0 | 0 |
| constrained | 45 | 1026 | 20550 | 0 | 0 | 0 | 0 |
| impaired | 35 | 943 | 12566 | 0 | 0 | 0 | 0 |
| recovery | 45 | 1029 | 33648 | 0 | 0 | 0 | 0 |
