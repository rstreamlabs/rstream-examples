...
Generated at 2026-08-17T01:25:07Z from repository revision `ca8a308907aaa5661954af81d10f04bd8e5f52bb`.
...
| producer-build-completed | 134.4 s |
| browser-build-started | 0.1 s |
| browser-build-completed | 23.8 s |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 100.0% | 7214 | n/a | 8000 | 8000 | 30.0 | 23.4 | 2.81 | 0.0% | 0 | 0 | 0 | 1 |
| baseline | 25 | 100.0% | 7145 | n/a | 8000 | 8000 | 30.0 | 23.2 | 2.81 | 0.0% | 0 | 0 | 0 | 0 |
| conditioning | 30 | 100.0% | 7122 | 22.3% | 8000 | 8000 | 30.0 | 23.3 | 2.78 | 0.0% | 0 | 0 | 0 | 4 |
| constrained | 45 | 100.0% | 2527 | 63.2% | 2300 | 2000 | 28.4 | 28.4 | 2.47 | 4.4% | 351 | 315 | 0 | 556 |
| impaired | 35 | 100.0% | 1908 | 47.7% | 2200 | 2000 | 28.9 | 31.6 | 2.25 | 5.8% | 353 | 188 | 0 | 197 |
| recovery | 45 | 100.0% | 6376 | 19.9% | 8000 | 7200 | 30.0 | 26.1 | 2.63 | 0.0% | 0 | 0 | 0 | 166 |
...
| Rate recovery | 18.1 s to threshold; 100.0% target residency in the best 10 s window; 21.1 s longest uninterrupted interval; received throughput 89.4% of the stable pre-transition rate | target reaches 80% within 35 s, sustains it for 10 s, and median throughput reaches at least 60% of baseline |
| Playback under impairment | 28.9 fps; 5.8% frozen | at least 20 fps; at most 10% frozen |
| Latency under impairment | 197 ms max RTT; 186.8 ms effective playout buffer | at most 600 ms RTT; at most 300 ms phase-average buffer |
| Visual quality under impairment | QP 31.6; 1920x1080 | QP at most 42; 1920x1080 |
| Loss fidelity | qdisc 1.88%; TWCC 3.51% | 2% injected; TWCC within 8 percentage points |
| Packet repair | NACK 353; sender RTX 374; receiver RTX 188 | NACK, sender RTX, and receiver RTX greater than zero |
| Sender queue | 225.0 ms residence; 61.7 ms admitted backlog; 0 overflow drops | at most 375 ms; at most 225 ms; zero overflow |
...
| constrained | 2750 | 4026 | 2000 | 67.27% | 5 / 1 | 0.00% | 2.72% | 14 | 0 | 688 | 65 | 0 |
| impaired | 2244 | 2274 | 0 | 13.33% | 0 / 0 | 3.34% | 3.51% | 1 | 0 | 549 | 325 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 36.4 | 36.4 | 0.0 | 45.0 | 45.8 | 27 | 67467 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| baseline | 36.5 | 36.5 | 0.0 | 45.5 | 45.8 | 13 | 68215 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| conditioning | 37.3 | 37.3 | 0.0 | 45.5 | 46.2 | 27 | 68020 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| constrained | 225.0 | 62.7 | 225.0 | 61.7 | 865.5 | 296 | 67600 | 0 | 1362 | 582 | 1 | 0 | 0 | 0 | 0 | 0 |
| impaired | 225.0 | 62.7 | 225.0 | 61.7 | 865.5 | 7 | 28846 | 0 | 0 | 2 | 0 | 0 | 0 | 0 | 0 | 0 |
| recovery | 225.0 | 62.7 | 225.0 | 61.7 | 865.5 | 25 | 67979 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 0 | 0 |
...
| constrained | 0.0 | 0 | 0 | 0 | 225.0 | 645 | 1362 | 582 | 3164 |
| impaired | 0.0 | 0 | 0 | 0 | 225.0 | 374 | 0 | 2 | 0 |
...
| baseline | 100 | 21.5% | 0.0% | 0.0% | 255 ms | 255 ms |
| conditioning | 118 | 22.4% | 0.0% | 0.0% | 253 ms | 254 ms |
| constrained | 177 | 20.6% | 0.0% | 0.0% | 254 ms | 254 ms |
| impaired | 138 | 20.2% | 0.0% | 0.0% | 254 ms | 255 ms |
| recovery | 178 | 22.4% | 0.0% | 0.0% | 255 ms | 255 ms |
...
| baseline | 99 | 21.6% | 0.0% | 0.0% | 255 ms | 255 ms |
| conditioning | 118 | 22.2% | 0.0% | 0.0% | 254 ms | 254 ms |
| constrained | 178 | 21.1% | 0.0% | 0.0% | 254 ms | 254 ms |
| impaired | 138 | 20.4% | 0.0% | 0.0% | 253 ms | 253 ms |
| recovery | 177 | 22.7% | 0.0% | 0.0% | 255 ms | 257 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| warmup | 601 | 36.5 | 38.3 | 0.00% | 0.00% |
| baseline | 761 | 36.8 | 39.3 | 0.00% | 0.00% |
| conditioning | 898 | 36.6 | 38.7 | 0.00% | 0.00% |
| constrained | 1351 | 36.1 | 37.6 | 0.00% | 0.00% |
| impaired | 1049 | 37.3 | 39.6 | 0.00% | 0.00% |
| recovery | 1350 | 36.1 | 38.6 | 0.00% | 0.00% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| capacity transitions | 0.00% | 13394 | 620 | 4.42% | n/a |
| constrained steady state | 0.00% | 8072 | 0 | 0.00% | 7/256 (2.7%) |
| impaired (incremental) | 2.00% | 10496 | 201 | 1.88% | 50/256 (19.5%) |
| recovery drain | 0.00% | 859 | 0 | 0.00% | 0/256 (0.0%) |
...
| --- | ---: | ---: |
| warmup | 189.5 | 186.0 |
| baseline | 189.9 | 186.0 |
| conditioning | 189.7 | 185.9 |
| constrained | 212.0 | 186.3 |
| impaired | 186.8 | 186.3 |
| recovery | 203.6 | 185.7 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 16808 | 358 | 0 | 0 | 0 | 0 |
| baseline | 25 | 21164 | 455 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 25397 | 552 | 0 | 1 | 0 | 0 |
| constrained | 45 | 21626 | 1154 | 0 | 0 | 0 | 0 |
| impaired | 35 | 10552 | 949 | 0 | 0 | 0 | 0 |
| recovery | 45 | 26860 | 824 | 0 | 0 | 0 | 0 |
...
| Phase | Samples | UDP received | UDP sent | Input errors | No-socket drops | Receive-buffer drops | Send-buffer drops |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 354 | 16783 | 0 | 0 | 0 | 0 |
| baseline | 25 | 447 | 21152 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 537 | 25395 | 0 | 0 | 0 | 0 |
| constrained | 45 | 1151 | 21612 | 0 | 0 | 0 | 620 |
| impaired | 35 | 948 | 10799 | 0 | 0 | 0 | 0 |
| recovery | 45 | 807 | 26792 | 0 | 0 | 0 | 0 |
