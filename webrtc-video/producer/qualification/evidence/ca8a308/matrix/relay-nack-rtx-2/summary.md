...
Generated at 2026-08-17T01:51:36Z from repository revision `ca8a308907aaa5661954af81d10f04bd8e5f52bb`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 100.0% | 6780 | n/a | 8000 | 7600 | 30.0 | 23.4 | 2.04 | 0.0% | 0 | 0 | 0 | 132 |
| baseline | 25 | 100.0% | 6625 | n/a | 8000 | 7600 | 30.0 | 23.6 | 2.13 | 0.0% | 0 | 0 | 0 | 133 |
| conditioning | 30 | 100.0% | 6977 | 21.8% | 8000 | 8000 | 30.0 | 23.3 | 2.26 | 0.0% | 0 | 0 | 0 | 179 |
| constrained | 45 | 100.0% | 2416 | 60.4% | 3200 | 2600 | 30.0 | 29.2 | 2.13 | 0.0% | 0 | 0 | 0 | 177 |
| impaired | 35 | 100.0% | 1894 | 47.4% | 2000 | 2000 | 28.2 | 31.3 | 1.85 | 16.2% | 530 | 198 | 0 | 317 |
| recovery | 44 | 100.0% | 2539 | 7.9% | 2950 | 2800 | 30.1 | 29.7 | 1.91 | 0.0% | 0 | 0 | 0 | 289 |

Congestion response: 14.1 s. Recovery response: not observed.
...
| --- | ---: | ---: |
| Shaper activation | 105.3% of baseline before the first capacity step | at least 80% |
| Rate response | 67.5% reduction in 14.1 s | at least 20% within 30 s |
| Rate recovery | not observed to threshold; 0.0% target residency in the best 10 s window; 0.0 s longest uninterrupted interval; received throughput 35.9% of the stable pre-transition rate | target reaches 80% within 35 s, sustains it for 10 s, and median throughput reaches at least 60% of baseline |
| Playback under impairment | 28.2 fps; 16.2% frozen | at least 20 fps; at most 10% frozen |
| Latency under impairment | 317 ms max RTT; 245.3 ms effective playout buffer | at most 600 ms RTT; at most 300 ms phase-average buffer |
| Visual quality under impairment | QP 31.3; 1920x1080 | QP at most 42; 1920x1080 |
| Loss fidelity | qdisc 2.00%; TWCC 5.51% | 2% injected; TWCC within 8 percentage points |
| Packet repair | NACK 530; sender RTX 592; receiver RTX 198 | NACK, sender RTX, and receiver RTX greater than zero |
| Sender queue | 51.7 ms residence; 57.6 ms admitted backlog; 0 overflow drops | at most 375 ms; at most 225 ms; zero overflow |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 2 | 0 | 304 | 0 | 0 |
| baseline | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 0 | 0 | 384 | 0 | 0 |
| conditioning | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 4 | 0 | 464 | 0 | 0 |
| constrained | 3165 | 3165 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 13 | 0 | 699 | 0 | 0 |
| impaired | 1861 | 2305 | 2000 | 15.38% | 2 / 0 | 5.35% | 5.51% | 8 | 0 | 531 | 371 | 0 |
| recovery | 2956 | 2957 | 0 | 15.38% | 0 / 1 | 0.00% | 0.09% | 6 | 0 | 703 | 10 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 44.7 | 44.7 | 0.0 | 53.2 | 54.2 | 19 | 65252 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| baseline | 44.7 | 44.7 | 0.0 | 53.2 | 54.2 | 25 | 67574 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| conditioning | 44.7 | 44.7 | 0.0 | 53.2 | 54.2 | 26 | 67916 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| constrained | 45.7 | 45.7 | 0.0 | 54.6 | 55.7 | 16 | 68062 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 0 | 0 |
| impaired | 51.7 | 51.7 | 38.8 | 57.6 | 58.8 | 6 | 32536 | 0 | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| recovery | 51.7 | 51.7 | 38.8 | 57.6 | 58.8 | 8 | 31980 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 0 | 0 |
...
| impaired | 0.0 | 0 | 0 | 0 | 38.8 | 592 | 0 | 1 | 0 |
| recovery | 0.0 | 0 | 0 | 0 | 38.8 | 8 | 0 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 18.6% | 0.0% | 0.0% | 253 ms | 253 ms |
| baseline | 99 | 18.2% | 0.0% | 0.0% | 254 ms | 254 ms |
| conditioning | 118 | 20.0% | 0.0% | 0.0% | 254 ms | 254 ms |
| constrained | 178 | 19.2% | 0.0% | 0.0% | 253 ms | 254 ms |
| impaired | 139 | 16.3% | 0.0% | 0.0% | 254 ms | 254 ms |
| recovery | 177 | 18.0% | 0.0% | 0.0% | 254 ms | 254 ms |
...
| Phase | Samples | Median active CPU | p95 steal | Maximum steal | p99 sampler gap | Maximum sampler gap |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 18.4% | 0.0% | 0.0% | 253 ms | 253 ms |
| baseline | 99 | 18.2% | 0.0% | 0.0% | 253 ms | 253 ms |
| conditioning | 118 | 20.2% | 0.0% | 0.0% | 253 ms | 254 ms |
| constrained | 178 | 19.2% | 0.0% | 0.0% | 253 ms | 254 ms |
| impaired | 139 | 17.0% | 0.0% | 0.0% | 253 ms | 254 ms |
| recovery | 177 | 18.0% | 0.0% | 0.0% | 254 ms | 254 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| warmup | 600 | 35.5 | 36.7 | 0.00% | 0.00% |
| baseline | 757 | 36.1 | 40.7 | 0.00% | 0.00% |
| conditioning | 901 | 36.1 | 37.2 | 0.00% | 0.00% |
| constrained | 1350 | 36.0 | 38.0 | 0.00% | 0.00% |
| impaired | 1052 | 35.5 | 41.8 | 0.00% | 0.00% |
| recovery | 1218 | 35.4 | 39.1 | 0.00% | 0.00% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| capacity transitions | 0.00% | 14367 | 0 | 0.00% | n/a |
| constrained steady state | 0.00% | 8452 | 0 | 0.00% | 4/256 (1.6%) |
| impaired (incremental) | 2.00% | 10853 | 221 | 2.00% | 56/256 (21.9%) |
| recovery drain | 0.00% | 437 | 0 | 0.00% | 0/256 (0.0%) |
...
| --- | ---: | ---: |
| warmup | 187.5 | 187.2 |
| baseline | 188.7 | 187.0 |
| conditioning | 189.8 | 187.0 |
| constrained | 186.9 | 187.0 |
| impaired | 245.3 | 187.1 |
| recovery | 207.0 | 187.2 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 14452 | 367 | 0 | 0 | 0 | 0 |
| baseline | 25 | 20076 | 453 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 23995 | 554 | 0 | 0 | 0 | 0 |
| constrained | 45 | 22967 | 799 | 0 | 0 | 0 | 0 |
| impaired | 35 | 10923 | 1145 | 0 | 1 | 0 | 0 |
| recovery | 45 | 15676 | 812 | 0 | 0 | 0 | 0 |
...
| Phase | Samples | UDP received | UDP sent | Input errors | No-socket drops | Receive-buffer drops | Send-buffer drops |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 381 | 14474 | 0 | 0 | 0 | 0 |
| baseline | 25 | 480 | 20108 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 580 | 24026 | 0 | 0 | 0 | 0 |
| constrained | 45 | 865 | 23021 | 0 | 0 | 0 | 0 |
| impaired | 35 | 1170 | 11221 | 0 | 0 | 0 | 0 |
| recovery | 45 | 868 | 15695 | 0 | 0 | 0 | 0 |
...
- FAIL — recovery-time: encoder target returns to at least 80% of its stable pre-transition target within 35 seconds of the capacity-restoration step
- FAIL — sustained-recovery: the encoder stays at or above 80% of its stable pre-transition target for at least 80% of a continuous 10-second window after capacity is restored
- FAIL — throughput-recovery: recovery median receive throughput returns to at least 60% of the stable pre-transition receive rate
