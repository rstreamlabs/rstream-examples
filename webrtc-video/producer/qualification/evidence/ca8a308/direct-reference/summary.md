...
Generated at 2026-08-17T01:18:01Z from repository revision `ca8a308907aaa5661954af81d10f04bd8e5f52bb`.
...
| producer-build-completed | 131.0 s |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 100.0% | 8783 | n/a | 8000 | 8000 | 30.0 | 23.3 | 2.97 | 0.0% | 0 | 0 | 3213 | 1 |
| baseline | 25 | 100.0% | 8587 | n/a | 8000 | 8000 | 30.1 | 23.0 | 2.98 | 0.0% | 0 | 0 | 4017 | 0 |
| conditioning | 30 | 100.0% | 8654 | 27.0% | 8000 | 8000 | 30.0 | 23.4 | 2.94 | 0.0% | 0 | 0 | 4948 | 1 |
| constrained | 45 | 100.0% | 2650 | 66.2% | 2400 | 2200 | 30.0 | 29.4 | 2.53 | 0.0% | 0 | 0 | 3419 | 14 |
| impaired | 35 | 100.0% | 2415 | 60.4% | 2200 | 2000 | 29.9 | 31.2 | 2.06 | 0.6% | 168 | 156 | 1950 | 199 |
| recovery | 45 | 100.0% | 8459 | 26.4% | 8000 | 8000 | 30.1 | 25.8 | 2.66 | 0.0% | 0 | 0 | 5596 | 4 |

Congestion response: 1.0 s. Recovery response: 17.1 s.

Selected ICE candidate-pair switches: 0. The direct-path address selector remains active across port changes.

Superseded out-of-order estimator callbacks: 1. The producer always applies the estimator's current target rather than the potentially stale callback payload.
...
| Rate recovery | 17.1 s to threshold; 100.0% target residency in the best 10 s window; 22.1 s longest uninterrupted interval; received throughput 98.8% of the stable pre-transition rate | target reaches 80% within 35 s, sustains it for 10 s, and median throughput reaches at least 60% of baseline |
| Playback under impairment | 29.9 fps; 0.6% frozen | at least 20 fps; at most 10% frozen |
| Latency under impairment | 199 ms max RTT; 193.5 ms effective playout buffer | at most 600 ms RTT; at most 300 ms phase-average buffer |
| Visual quality under impairment | QP 31.2; 1920x1080 | QP at most 42; 1920x1080 |
| Loss fidelity | qdisc 1.95%; TWCC 2.04% | 2% injected; TWCC within 8 percentage points |
| Packet repair | NACK 168; sender RTX 173; receiver RTX 156; FlexFEC 1950 | NACK, sender RTX, and FlexFEC greater than zero |
| Sender queue | 55.3 ms residence; 52.1 ms admitted backlog; 0 overflow drops | at most 375 ms; at most 225 ms; zero overflow |
...
| constrained | 2441 | 2465 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 21 | 0 | 704 | 0 | 0 |
| impaired | 2229 | 2261 | 0 | 9.52% | 0 / 0 | 1.50% | 2.04% | 2 | 0 | 551 | 145 | 0 |
| recovery | 8000 | 8000 | 0 | 0.00% | 0 / 0 | 0.00% | 0.00% | 6 | 0 | 704 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 35.7 | 35.7 | 35.6 | 37.8 | 44.4 | 32 | 68058 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| baseline | 37.4 | 37.4 | 36.9 | 37.9 | 46.1 | 33 | 68203 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| conditioning | 37.4 | 37.4 | 37.2 | 37.9 | 46.6 | 31 | 67899 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| constrained | 55.3 | 55.3 | 54.2 | 52.1 | 60.4 | 14 | 66271 | 0 | 0 | 24 | 0 | 0 | 0 | 0 | 0 | 0 |
| impaired | 55.3 | 55.3 | 54.2 | 52.1 | 60.4 | 10 | 22183 | 0 | 0 | 15 | 0 | 0 | 0 | 0 | 0 | 0 |
| recovery | 55.3 | 55.3 | 54.2 | 52.1 | 60.4 | 33 | 68300 | 0 | 0 | 5 | 1 | 0 | 0 | 0 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 35.6 | 3191 | 0 | 0 | 0.0 | 0 | 0 | 0 | 0 |
| baseline | 36.9 | 3998 | 0 | 0 | 0.0 | 0 | 0 | 0 | 0 |
| conditioning | 37.2 | 4902 | 0 | 0 | 0.0 | 0 | 0 | 0 | 0 |
| constrained | 54.2 | 3455 | 0 | 24 | 0.0 | 0 | 0 | 0 | 0 |
| impaired | 54.2 | 2038 | 0 | 14 | 35.6 | 173 | 0 | 1 | 0 |
| recovery | 54.2 | 5544 | 0 | 5 | 35.6 | 0 | 0 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 23.5% | 0.0% | 0.0% | 254 ms | 254 ms |
| baseline | 100 | 23.5% | 0.0% | 0.0% | 257 ms | 257 ms |
| conditioning | 118 | 25.4% | 0.0% | 0.0% | 255 ms | 255 ms |
| constrained | 177 | 23.2% | 0.0% | 0.0% | 254 ms | 255 ms |
| impaired | 138 | 22.0% | 0.0% | 0.0% | 254 ms | 255 ms |
| recovery | 178 | 24.5% | 0.0% | 0.0% | 254 ms | 255 ms |
...
| baseline | 99 | 23.2% | 0.0% | 0.0% | 254 ms | 254 ms |
| conditioning | 118 | 25.5% | 0.0% | 0.0% | 255 ms | 255 ms |
| constrained | 178 | 23.2% | 0.0% | 0.0% | 254 ms | 255 ms |
| impaired | 138 | 22.0% | 0.0% | 0.0% | 254 ms | 254 ms |
| recovery | 177 | 24.5% | 0.0% | 0.0% | 254 ms | 255 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| warmup | 602 | 36.6 | 41.8 | 0.00% | 0.00% |
| baseline | 761 | 38.1 | 43.2 | 0.00% | 0.00% |
| conditioning | 901 | 35.9 | 43.1 | 0.00% | 0.00% |
| constrained | 1348 | 37.1 | 44.3 | 0.00% | 0.00% |
| impaired | 1052 | 36.6 | 40.7 | 0.00% | 0.00% |
| recovery | 1349 | 36.3 | 44.4 | 0.00% | 0.00% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| capacity transitions | 0.00% | 12115 | 0 | 0.00% | n/a |
| constrained steady state | 0.00% | 9165 | 0 | 0.00% | 4/256 (1.6%) |
| impaired (incremental) | 2.00% | 12233 | 243 | 1.95% | 66/256 (25.8%) |
| recovery drain | 0.00% | 1004 | 0 | 0.00% | 1/256 (0.4%) |
...
| --- | ---: | ---: |
| warmup | 189.2 | 185.7 |
| baseline | 189.7 | 185.6 |
| conditioning | 190.2 | 186.0 |
| constrained | 194.7 | 185.8 |
| impaired | 193.5 | 186.8 |
| recovery | 205.9 | 186.0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 20079 | 461 | 0 | 0 | 0 | 0 |
| baseline | 25 | 25097 | 577 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 30549 | 686 | 0 | 0 | 0 | 0 |
| constrained | 45 | 21556 | 1042 | 0 | 0 | 0 | 0 |
| impaired | 35 | 12248 | 965 | 0 | 0 | 0 | 0 |
| recovery | 45 | 33620 | 1047 | 0 | 0 | 0 | 0 |
...
| Phase | Samples | UDP received | UDP sent | Input errors | No-socket drops | Receive-buffer drops | Send-buffer drops |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 21 | 457 | 20072 | 0 | 0 | 0 | 0 |
| baseline | 25 | 569 | 25087 | 0 | 0 | 0 | 0 |
| conditioning | 30 | 683 | 30554 | 0 | 0 | 0 | 0 |
| constrained | 45 | 1027 | 21473 | 0 | 0 | 0 | 0 |
| impaired | 35 | 966 | 12540 | 0 | 0 | 0 | 0 |
| recovery | 45 | 1028 | 33587 | 0 | 0 | 0 | 0 |
