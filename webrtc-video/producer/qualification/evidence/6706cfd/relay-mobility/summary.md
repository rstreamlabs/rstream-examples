...
Generated at 2026-08-16T13:37:25Z from repository revision `6706cfdf830ded88a718bc35c6b4a94a0a69e089`.
...
| producer-build-completed | 1.4 s |
...
Measured service establishment: 9.6 s.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 100.0% | 2975 | n/a | 2100 | 2000 | 29.9 | 29.7 | 1.46 | 0.0% | 1 | 1 | 4148 | 192 |
| baseline | 26 | 100.0% | 3036 | n/a | 2100 | 2000 | 30.0 | 29.5 | 1.46 | 0.0% | 2 | 3 | 5434 | 176 |
| mobility | 30 | 96.7% | 3072 | n/a | 2100 | 2000 | 22.1 | 29.5 | 1.45 | 0.6% | 3 | 3 | 4967 | 139 |
| constrained | 45 | 100.0% | 3045 | 76.1% | 2100 | 2000 | 29.5 | 29.6 | 1.44 | 1.3% | 13 | 20 | 9590 | 265 |
| impaired | 36 | 100.0% | 2955 | 73.9% | 2150 | 2000 | 29.7 | 29.7 | 1.43 | 2.7% | 224 | 196 | 7424 | 344 |
| recovery | 45 | 100.0% | 3007 | n/a | 2100 | 2000 | 30.2 | 29.6 | 1.43 | 0.0% | 7 | 10 | 9656 | 269 |
...
Superseded out-of-order estimator callbacks: 10. The producer always applies the estimator's current target rather than the potentially stale callback payload.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 2063 | 2074 | 0.00% | 0.00% | 3 | 0 | 304 | 0 | 0 |
| baseline | 2113 | 2132 | 0.00% | 0.03% | 6 | 0 | 399 | 5 | 0 |
| mobility | 2101 | 2167 | 0.00% | 25.81% | 8 | 0 | 351 | 0 | 0 |
| constrained | 2150 | 2166 | 0.00% | 0.20% | 13 | 0 | 717 | 14 | 0 |
| impaired | 2172 | 2207 | 2.29% | 2.21% | 0 | 0 | 573 | 284 | 0 |
| recovery | 2134 | 2138 | 0.00% | 0.08% | 8 | 0 | 705 | 9 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 99.9 | 99.9 | 89.7 | 86.3 | 97.9 | 30 | 21437 | 0 | 0 | 29 | 1 | 0 | 0 | 0 | 0 | 0 |
| baseline | 116.9 | 116.9 | 107.1 | 89.5 | 107.6 | 36 | 21046 | 0 | 0 | 96 | 0 | 0 | 0 | 0 | 0 | 0 |
| mobility | 185.2 | 185.2 | 109.7 | 144.0 | 161.1 | 85 | 28209 | 0 | 0 | 91 | 1 | 0 | 0 | 0 | 0 | 0 |
| constrained | 221.8 | 185.2 | 221.8 | 144.0 | 161.1 | 51 | 22114 | 0 | 74 | 99 | 2 | 0 | 0 | 0 | 0 | 0 |
| impaired | 221.8 | 185.2 | 221.8 | 144.0 | 161.1 | 67 | 19524 | 0 | 0 | 104 | 0 | 0 | 0 | 0 | 0 | 0 |
| recovery | 221.8 | 185.2 | 221.8 | 144.0 | 161.1 | 32 | 19790 | 0 | 0 | 53 | 2 | 0 | 0 | 0 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 89.7 | 0 | 0 | 29 | 30.8 | 1 | 0 | 0 |
| baseline | 107.1 | 0 | 0 | 96 | 32.9 | 3 | 0 | 0 |
| mobility | 109.7 | 0 | 0 | 91 | 32.9 | 3 | 0 | 0 |
| constrained | 124.1 | 0 | 0 | 99 | 221.8 | 26 | 74 | 0 |
| impaired | 129.3 | 0 | 0 | 98 | 221.8 | 229 | 0 | 6 |
| recovery | 129.3 | 0 | 0 | 53 | 221.8 | 17 | 0 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 8.8% | 0.0% | 0.0% | 254 ms | 254 ms |
| baseline | 100 | 8.8% | 0.0% | 0.0% | 256 ms | 256 ms |
| mobility | 121 | 8.5% | 0.0% | 0.0% | 255 ms | 258 ms |
| constrained | 178 | 8.8% | 0.0% | 0.0% | 256 ms | 256 ms |
| impaired | 142 | 8.4% | 0.0% | 0.0% | 255 ms | 255 ms |
| recovery | 180 | 8.8% | 0.0% | 0.0% | 254 ms | 255 ms |
...
| Phase | Samples | Median active CPU | p95 steal | Maximum steal | p99 sampler gap | Maximum sampler gap |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 79 | 8.8% | 0.0% | 0.0% | 261 ms | 261 ms |
| baseline | 100 | 8.9% | 0.0% | 0.0% | 255 ms | 255 ms |
| mobility | 120 | 8.8% | 0.0% | 0.0% | 255 ms | 259 ms |
| constrained | 178 | 8.8% | 0.0% | 0.0% | 257 ms | 264 ms |
| impaired | 142 | 8.5% | 0.0% | 0.0% | 254 ms | 257 ms |
| recovery | 179 | 8.6% | 0.0% | 0.0% | 258 ms | 259 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| warmup | 606 | 38.9 | 41.7 | 0.00% | 0.00% |
| baseline | 758 | 38.1 | 42.2 | 0.00% | 0.00% |
| mobility | 918 | 38.7 | 41.5 | 0.00% | 0.00% |
| constrained | 1352 | 38.6 | 42.1 | 0.00% | 0.00% |
| impaired | 1078 | 37.7 | 40.7 | 0.00% | 0.00% |
| recovery | 1288 | 38.5 | 43.6 | 0.00% | 0.00% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| capacity transitions | 0.00% | 9766 | 0 | 0.00% | n/a |
| constrained steady state | 0.00% | 19800 | 0 | 0.00% | 85/256 (33.2%) |
| impaired (incremental) | 2.00% | 22463 | 479 | 2.09% | 122/256 (47.7%) |
| recovery drain | 0.00% | 775 | 0 | 0.00% | 0/256 (0.0%) |
...
| --- | ---: | ---: |
| warmup | 204.5 | 188.0 |
| baseline | 208.0 | 188.0 |
| mobility | 186.7 | 188.0 |
| constrained | 214.1 | 188.0 |
| impaired | 234.0 | 188.0 |
| recovery | 248.4 | 188.0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 13133 | 459 | 0 | 2 | 0 | 0 |
| baseline | 25 | 16455 | 577 | 0 | 0 | 0 | 0 |
| mobility | 31 | 15881 | 657 | 0 | 0 | 0 | 0 |
| constrained | 45 | 29562 | 1051 | 0 | 0 | 0 | 0 |
| impaired | 36 | 23258 | 1047 | 0 | 0 | 0 | 0 |
| recovery | 45 | 29678 | 1044 | 0 | 0 | 0 | 0 |
...
| Phase | Samples | UDP received | UDP sent | Input errors | No-socket drops | Receive-buffer drops | Send-buffer drops |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| warmup | 20 | 482 | 13170 | 0 | 0 | 0 | 0 |
| baseline | 25 | 610 | 16521 | 0 | 0 | 0 | 0 |
| mobility | 31 | 611 | 20822 | 0 | 0 | 0 | 0 |
| constrained | 45 | 1108 | 29764 | 0 | 0 | 0 | 0 |
| impaired | 36 | 1089 | 23698 | 0 | 0 | 0 | 0 |
| recovery | 45 | 1093 | 29764 | 0 | 0 | 0 | 0 |
