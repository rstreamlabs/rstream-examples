...
func (c *Collector) Collect(ch chan<- prometheus.Metric) {
	...
	ch <- prometheus.MustNewConstMetric(c.pacerRepairPacketsDiscarded, prometheus.CounterValue, float64(producer.PacerRetransmissionPacketsExpired), "retransmission", "expired")
	...
	ch <- prometheus.MustNewConstMetric(c.pacerRepairPacketsDiscarded, prometheus.CounterValue, float64(producer.PacerRetransmissionPacketsTrimmed), "retransmission", "trimmed")
	...
	ch <- prometheus.MustNewConstMetric(c.pacerRepairPacketsDiscarded, prometheus.CounterValue, float64(producer.PacerRetransmissionPacketsCoalesced), "retransmission", "coalesced")
	ch <- prometheus.MustNewConstMetric(c.pacerRepairPacketsDiscarded, prometheus.CounterValue, float64(producer.PacerRetransmissionPacketsSuppressed), "retransmission", "suppressed")
	ch <- prometheus.MustNewConstMetric(c.pacerSentPackets, prometheus.CounterValue, float64(producer.PacerSentPrimary), "primary")
	ch <- prometheus.MustNewConstMetric(c.pacerSentPackets, prometheus.CounterValue, float64(producer.PacerSentRetransmission), "retransmission")
	...
	ch <- prometheus.MustNewConstMetric(c.pacerSentBytes, prometheus.CounterValue, float64(producer.PacerSentRetransmissionBytes), "retransmission")
